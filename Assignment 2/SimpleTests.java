...
public class SimpleTests {
	public static void main(String args[]) {
		...
		ThreeCushion game1 = new ThreeCushion(PLAYER_A, 3);
		game1.lagWinnerChooses(true, WHITE);
		game1.cueBallStrike(WHITE);
		game1.endShot();
		game1.cueStickStrike(YELLOW);
		game1.cueBallStrike(WHITE);
		game1.cueBallImpactCushion();
		game1.cueBallImpactCushion();
		game1.cueBallImpactCushion();
		game1.cueBallStrike(RED);
		game1.endShot();
		System.out.println(game1.getPlayerBScore() + 1);
	}
}
