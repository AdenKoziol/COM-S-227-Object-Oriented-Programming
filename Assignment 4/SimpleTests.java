...
public class SimpleTests {
	...
	System.out.println("Straight, turn, switch link - shiftPoints tests");
	System.out.println();
	//straight test
	...
	link4.shiftPoints(position);
	if (position.getPointA() == path1.getHighpoint() && position.getPointB().getPointIndex() == path1.getHighpoint().getPointIndex()-1) 
		System.out.println("Position correctly moved to path 2.");
	else 
		System.out.println("Position not correctly moved to path 2.");
	System.out.println();
	...
	position.setPointB(lowPointB);
	link6.shiftPoints(position);
	if (position.getPointA() == path4.getHighpoint() && position.getPointB().getPointIndex() == path4.getHighpoint().getPointIndex()-1) 
		System.out.println("Position correctly moved to path 2.");
	else
		System.out.println("Position not correctly moved to path 2.");
	System.out.println();
